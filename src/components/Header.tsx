...
const Header = () => {
  return (
    ...
    // </header>
    <header>
      <nav className='fixedbg-white border-gray-200 dark:bg-gray-900'>
        <div className='flex flex-wrap items-center justify-between mx-auto p-4'>
          <a href='/' className='flex items-center space-x-3 rtl:space-x-reverse'>
            <img src='../favicon.ico' className='h-8' alt='Logo' />
            <span className='self-center text-2xl font-semibold whitespace-nowrap dark:text-white'>Guitar Tunar</span>
          </a>
          {/* will expand this if theres a need for menu dropdown */}
